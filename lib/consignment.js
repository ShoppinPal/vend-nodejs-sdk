...
var fetchStockOrdersForSuppliers = function(args, connectionInfo, retryCounter) {
  ...
  var getOrdersFromSuppliers = utils.sendRequest(options, args, connectionInfo, fetchStockOrdersForSuppliers, retryCounter);
  return getOrdersFromSuppliers.data;
};
...
var fetchConsignment  = function(args, connectionInfo, retryCounter) {
  ...
  var getConsignment = utils.sendRequest(options, args, connectionInfo, fetchConsignment, retryCounter);
  return getConsignment.data;
};
...
var createStockOrder = function(args, connectionInfo, retryCounter) {
  ...
  var createdStockOrder = utils.sendRequest(options, args, connectionInfo, createStockOrder, retryCounter);
  return createdStockOrder.data;
};
...
var markStockOrderAsSent = function(args, connectionInfo, retryCounter) {
  ...
  log.debug(options.method + ' ' + options.url);
  log.debug( { message: 'body', body: options.json } );
  var updateConsignmentToSent = utils.sendRequest(options, args, connectionInfo, markStockOrderAsSent, retryCounter);
  return updateConsignmentToSent.data;
};
...
var markStockOrderAsReceived = function(args, connectionInfo, retryCounter) {
  ...
  var updateConsignmentToReceived = utils.sendRequest(options, args, connectionInfo, markStockOrderAsReceived, retryCounter);
  return updateConsignmentToReceived.data;
};
...
var deleteStockOrder = function(args, connectionInfo, retryCounter) {
  ...
  var consignmentDelete = utils.sendRequest(options, args, connectionInfo, deleteStockOrder, retryCounter);
  return consignmentDelete.data;
};
