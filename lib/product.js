...
var fetchProductV2 = function(args, connectionInfo, retryCounter) {
  ...
  var path = '/api/2.0/products/' + args.apiId.value;
  var vendUrl = 'https://' + connectionInfo.domainPrefix + '.vendhq.com' + path;
  log.debug('Requesting vend product ' + vendUrl);
  var authString = 'Bearer ' + connectionInfo.accessToken;
  log.debug('GET ' + vendUrl);
  ...
  return utils.sendRequest(options, args, connectionInfo, fetchProductV2, retryCounter);
};
...
var updateProductById = function(args, connectionInfo, retryCounter) {
  ...
  var path = '/api/2.1/products/' + args.apiId.value;
  var vendUrl = 'https://' + connectionInfo.domainPrefix + '.vendhq.com' + path;
  var authString = 'Bearer ' + connectionInfo.accessToken;
