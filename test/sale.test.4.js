...
describe('vend-nodejs-sdk', function () {
  ...
  describe('when a refreshToken is available', function () {
    ...
    describe.only('with sales API', function(){
      ...
      /**
       * Conclusion - The lineitem tax amount is still king ... taxId is either being ignored or only used for displaying a taxName in Vend UI
       */
      describe('this will create a sale with all the relevant data with mismatched tax amount and taxId', function () {
        ...
        var registerSale = { /* eslint-disable camelcase */
          ...
          note: 'This sale is created with all the relevant data with mismatched tax amount and taxId',
          status: 'CLOSED',
